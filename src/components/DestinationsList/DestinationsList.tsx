    ...
    return (
        <section className="bg-dark-900 rounded-2xl p-6 border border-dark-800">
                            ...
                            <div key={dest.id} className="group relative">
                                <div
                                    ...
                                    className={`flex items-center gap-3 p-3 rounded-xl transition-all ${
                                        isCloudConnected ? 'cursor-pointer' : 'cursor-default'
                                    } ${
                                        isSelected
                    ...
                    return (
                        <div key={dest.id} className="group relative">
                            ...
                            >
                                ...
                                >
                                    <span
                                        className={`w-1.5 h-1.5 rounded-full ${dest.available ? 'bg-success-400' : 'bg-dark-500'}`}
                                    />
                            ...
                            {isUsb && dest.available && (
                                <button
                                    ...
                                    className={`absolute right-36 top-1/2 -translate-y-1/2 p-1.5 rounded-lg transition-colors flex items-center gap-2 ${
                                        isAutoBackup
                                    ...
                                    title={
                                        isAutoBackup
                                            ...
                                            : 'Activer la sauvegarde automatique au branchement'
                                    }
                                >
                                    <svg
                                        className="w-4 h-4"
            ...
            <p className="mt-4 text-xs text-dark-500 text-center">
                💡 Branchez votre disque externe et activez ⚡ pour lancer une sauvegarde
                automatique
            </p>
        </section>
    )
